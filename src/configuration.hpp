...
std::map<short, std::map<short, std::pair<short, std::vector<std::pair<std::string, std::string>>>>> CONFIGURATION = {
    {901, { // move trigger
        {srcObjType::any,  {funcType::addGr, {{"Target", "51,g"}, {"TargetPos", "100,1,394,0,71,g"}, {"Center", "100,1,394,0,395,g"}}}},
    }},
};
